...
*---------------------------------------------------------*
* SEGUNDA PARTE (CORRER HASTA LINEA 51)
...
reg sale_price pand_q pandemic i.cod_comuna 1.quarter 2.quarter 3.quarter, vce(cl cod_comuna)
* siempre omite summer

reg sale_price pandemic
